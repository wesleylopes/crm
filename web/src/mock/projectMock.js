...
mock.onGet('/api/projects').reply(200, {
  projects: [
    {
      id: uuid(),
      title: '[Tiket#20201008 ] 10 - Aguas Mariza - Filial 1',
      subject:'Alteração de Vencimentos de conhecimento de fretes',
      author: {
        name: 'Ailton Aires',
        avatar: '/images/logos/clientes/logo-aguas-mariza.png',
      ...
      support_analyst_owner: {
        name: 'Alan Carlos',
        avatar: 'images/logos/clientes/logo-aguas-mariza.png'
      }, 
      developer:{
        name: 'Wesley Lopes',
        avatar: '/images/avatars/1234.png'
      },  
      project_modules: [
        {
          id: '1'
      ...
      priority:'high',
      status: 'Em Andamento Desenvolvimento',
      activities: 5,
      tags: [
        {
          text: 'Boleto, NFE',
      ...
      end_date: moment(),
      updated_at: moment().subtract(33, 'minutos')
    }
